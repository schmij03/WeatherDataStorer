...
from openweathermap import fetch_weatherdata_hour, fetch_weatherdata_current
...
pd_test.to_csv(f'backend/DataGathering/Files/AllWeatherDataCH_{rounded_hour_csv}.csv', index=False)
print('CH data saved successfully.')

pd_test = get_current_data(allstations)
pd_test.to_csv(f'backend/DataGathering/Files/AllWeatherDataNotCH_{rounded_hour_csv}.csv', index=False)
